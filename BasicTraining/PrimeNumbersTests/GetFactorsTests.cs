...
namespace PrimeNumbersTests
{
    ...
    class GetFactorsTests
    {
        ...
        {
            Assert.Throws<NotSupportedException>(() => PrimeNumbers.GetFactors(-74).ToList(), "Negative numbers are not supported. Technically, all negative numbers have the same factors as positive numbers, and positive numbers have both negative and positive factors, but let's keep things simple and not support negative numbers");
        }
